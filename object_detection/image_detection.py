...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path', type=str, default='dogs.jpeg',
                        help='Path to the image to perform detection')
    ...
    # run warmup with random images, default iters = 30
    inferator.warmup()

    # perform inference on given image
    inferator.run_inference(image_path=args.image_path, labels=labels, threshold=args.threshold)     
